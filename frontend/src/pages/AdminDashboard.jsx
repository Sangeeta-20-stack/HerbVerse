...
const AdminDashboard = () => (
  <div className="min-h-screen bg-gradient-to-br from-[#eef6f1] to-[#d9f0e4] font-inter">
    ...
    <div className="p-6 md:p-10 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <Link
        to="/admin/tours"
        className="bg-gradient-to-r from-green-400 to-green-600 text-white px-6 py-8 rounded-3xl shadow-2xl transform transition-all duration-300 hover:-translate-y-2 hover:shadow-3xl flex flex-col items-center justify-center text-center gap-3"
      >
